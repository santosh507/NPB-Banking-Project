    ...
    if accountObj.errorFlag == '1':
        ...
        print ("""
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="TransferMoney.css">
            </head>
            <body>
            <div class ="bg">
            <div class="Transfer Money">
                <h1><u><b>NPB-Bank Transfer Money</u></b></h1></br></br>
            ...
            <input type="hidden" name="mode" value="*TRNSFRMONY"/>
            Payee Bank Name:
            ...
            Amount to transfer: <input type="number" name="transferAmount" required/><br/><br/>
